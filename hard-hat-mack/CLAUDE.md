...
| level screens drawn from the file alone | recall **90% / 83% / 76%**, precision **91% / 95% / 90%**; the pixels the game draws are **93% / 89% / 90%** covered, with 10% / 4% / 7% drawn that it does not |
