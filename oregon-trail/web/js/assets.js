...
// FLOAT sprite records read from DS:0x5a, 0x62, 0x6a in unpacked.exe
// (per proc_055BA in oregon.asm). Each is a wagon-on-water pose
// picked by the crossing outcome byte at ss:[di - 0x22d]:
//   0 -> safe crossing
//   1 -> tipped, nothing lost
//   2 -> tipped, lost things
// Blit anchor is at y = 110 (0x6E in the code); the sprite is drawn
// with its bottom at that y-line, so anchorY - height.
export const FLOAT_SPRITES = {
    sourceKey: ASSET_KEYS.FLOAT,
    anchorY: 110,
    // DOS water rectangle at image 0x055F2..0x05606: (80, 25) to
    // (240, 150) on the 320x200 canvas -- 160 wide, 125 tall.
    waterRect: { x: 80, y: 25, w: 160, h: 125 },
    outcomes: [
        { sx:  92, sy: 4, sw: 76, sh: 42 },   // 0: safe crossing
        { sx: 168, sy: 4, sw: 56, sh: 38 },   // 1: tipped, nothing lost
        { sx:   4, sy: 5, sw: 80, sh: 51 },   // 2: tipped, lost things
    ],
};
